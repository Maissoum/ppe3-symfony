 ...
 */
final class Version20260101142038 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE user ADD abonnement_id INT DEFAULT NULL, ADD abonnement_fin DATETIME DEFAULT NULL');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE user DROP abonnement_id, DROP abonnement_fin');
    }
}
